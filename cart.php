...
<section class="webshop">
        ...
        <div class="shopping-cart">
            ...
            <?php if ($shoppingCart->hasProducts()): ?>
                ...
                <?php foreach ($shoppingCart->getProducts() as $index => $product): ?>
                    ...
                    <img src="<?php echo $product->getImageURL() ?>" alt="Foto van <?php echo $product->getTitle() ?>"><br /><hr />
                    <?php $totalprice = $totalprice + $product->getPrice() ?>
                <?php endforeach; ?>
    ...
    <footer>
        <a href="index.php">Naar de producten</a><br/>
        <a href="cart.php?action=clear_cart">Winkelwagen leegmaken</a>
    </footer>
</section>
</body>
</html>